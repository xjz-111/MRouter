...
public class VersionUtils {
    ...
    public static boolean isNewVersion(Context context) {
        ...
        if (null != packageInfo) {
            ...
            SharedPreferences sp = context.getSharedPreferences(Constant.MROUTER_CACHE_SP, Context.MODE_PRIVATE);
    ...
    public static void updateVersion(Context context) {
        if (!android.text.TextUtils.isEmpty(NEW_VERSION_NAME) && NEW_VERSION_CODE != 0) {
            SharedPreferences sp = context.getSharedPreferences(Constant.MROUTER_CACHE_SP_KEY, Context.MODE_PRIVATE);
